...
- Fix native library loading for osx-arm64 (#17495) (Thanks @github-actions[bot]!)

### Tests

- Make Assembly Load Native test work on a FX Dependent Linux Install (#17496) (Thanks @github-actions[bot]!)
- Enable more tests to be run in a container. (#17294)
- Switch to using GitHub action to verify markdown links for PRs (#17281)
- Try to stabilize a few tests that fail intermittently (#17426) (Thanks @github-actions[bot]!)
...
<li>Update to use <code>windows-latest</code> as the build agent image (#17418) (Thanks @github-actions[bot]!)</li>
<li>Publish preview versions of mariner to preview repo (#17464) (Thanks @github-actions[bot]!)</li>
<li>Move <code>cgmanifest</code> generation to daily (#17258)</li>
<li>Fix mariner mappings (#17413)</li>
<li>Make sure we execute tests on LTS package for older LTS releases (#17430) (Thanks @github-actions[bot]!)</li>
<li>Add a finalize template which causes jobs with issues to fail (#17428) (Thanks @github-actions[bot]!)</li>
<li>Make mariner packages Framework dependent (#17425) (Thanks @github-actions[bot]!)</li>
